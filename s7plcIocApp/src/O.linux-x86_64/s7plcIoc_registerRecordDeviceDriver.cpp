...
/* Generated from ../O.Common/s7plcIoc.dbd */
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devAiGeneralTime, *pvar_dset_s7plcAi, *pvar_dset_devAoSoft,
    *pvar_dset_devAoSoftRaw, *pvar_dset_devAoSoftCallback,
    *pvar_dset_s7plcAo, *pvar_dset_devBiSoft, *pvar_dset_devBiSoftRaw,
    *pvar_dset_devBiSoftCallback, *pvar_dset_devBiDbState,
    *pvar_dset_s7plcBi, *pvar_dset_s7plcStat, *pvar_dset_devBoSoft,
    *pvar_dset_devBoSoftRaw, *pvar_dset_devBoSoftCallback,
    *pvar_dset_devBoGeneralTime, *pvar_dset_devBoDbState,
    *pvar_dset_s7plcBo, *pvar_dset_devCalcoutSoft,
    *pvar_dset_devCalcoutSoftCallback, *pvar_dset_s7plcCalcout,
...
static const char * const deviceSupportNames[] = {
    ...
    "devAiSoftCallback", "devTimestampAI", "devAiGeneralTime", "s7plcAi",
    "devAoSoft", "devAoSoftRaw", "devAoSoftCallback", "s7plcAo",
    "devBiSoft", "devBiSoftRaw", "devBiSoftCallback", "devBiDbState",
    "s7plcBi", "s7plcStat", "devBoSoft", "devBoSoftRaw",
    "devBoSoftCallback", "devBoGeneralTime", "devBoDbState", "s7plcBo",
    "devCalcoutSoft", "devCalcoutSoftCallback", "s7plcCalcout",
...
static const dset * const devsl[] = {
    ...
    pvar_dset_s7plcAi, pvar_dset_devAoSoft, pvar_dset_devAoSoftRaw,
    pvar_dset_devAoSoftCallback, pvar_dset_s7plcAo, pvar_dset_devBiSoft,
    pvar_dset_devBiSoftRaw, pvar_dset_devBiSoftCallback,
    pvar_dset_devBiDbState, pvar_dset_s7plcBi, pvar_dset_s7plcStat,
    pvar_dset_devBoSoft, pvar_dset_devBoSoftRaw,
    pvar_dset_devBoSoftCallback, pvar_dset_devBoGeneralTime,
    pvar_dset_devBoDbState, pvar_dset_s7plcBo, pvar_dset_devCalcoutSoft,
    pvar_dset_devCalcoutSoftCallback, pvar_dset_s7plcCalcout,
    pvar_dset_devEventSoft, pvar_dset_devHistogramSoft,
    pvar_dset_devI64inSoft, pvar_dset_devI64inSoftCallback,
    pvar_dset_devI64outSoft, pvar_dset_devI64outSoftCallback,
...
int s7plcIoc_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/admin/mystplcApp";
...
/* s7plcIoc_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"s7plcIoc_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    s7plcIoc_registerRecordDeviceDriver(*iocshPpdbbase);
}
